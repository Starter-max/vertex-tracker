      ...
      <section className="mx-auto flex min-h-screen max-w-4xl flex-col px-4 pb-24 pt-6">
        <header className="mb-6 flex items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">Сначала захват, потом один раз в день сортировка.</p>
          </div>
          <div className="rounded-full border border-slate-700 px-3 py-1 text-sm text-slate-300">Inbox: {inboxCount}</div>
        </header>
